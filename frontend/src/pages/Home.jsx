        ...
        <section className="contact section container" id="contact">
            <div className="contact__container grid">
                ...
                <ul className="contact__content grid">
                    <li className="contact__address">Telephone: <span className="contact__information">+91 8618727271</span>
                    </li>
                    <li className="contact__address">Email: <span
                            className="contact__information">MediVault@gmail.com@</span></li>
                    <li className="contact__address">Location: <span className="contact__information">CMR university Yelahanka, Bengaluru, Karnataka 560063</span></li>
                </ul>
                <iframe
                    src="https://www.google.com/maps?q=CMR+University&output=embed"

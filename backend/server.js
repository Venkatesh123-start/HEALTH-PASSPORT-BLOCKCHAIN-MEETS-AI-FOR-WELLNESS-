...
app.use("/api/doctor", require("./routes/doctorRoutes")); // Alias for singular form
app.use("/api/insurance", require("./routes/insuranceRoutes"));
app.use("/api/labs", require("./routes/labRoutes"));
app.use("/api/patients", require("./routes/patientRoutes"));
app.use("/api/patient", require("./routes/patientRoutes")); // Alias for singular form
...
app.use((err, req, res, next) => {
  ...
  if (err.name === 'MulterError' || err.isMullerError) {
...
app.use((err, req, res, next) => {
  ...
  if (err.isMullerError || (err.name && err.name.includes('MulterError'))) {
    statusCode = 400;
    message = err.message || "File upload error";
  }
